"""
check if a SLL contains a cycle
cycle: a node's next node points to *any* precious node in the list
"""

import unittest

# use two pointer approch: slow and fast, 
# when they meet, we have a cycle, else no cycle found 
